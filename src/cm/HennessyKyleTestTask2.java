...
public class HennessyKyleTestTask2 {
    ...
    public void calculateTestCaseValidInput6() {
        ...
        r = new Rate(park, normalRate, reducedRate, reducedPeriods, normalPeriods);
        assertEquals( BigDecimal.valueOf(0), r.calculate(normalPeriod1)); //Calculate = 0 as parking in free times (0-7 is free)
    }
    ...
    public void calculateTestCaseValidInput9() {
        ...
        Period freePeriod = new Period(0,13);
